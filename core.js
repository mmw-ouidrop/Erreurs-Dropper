...
const OD = {
  ...
  GAS_URL: 'https://script.google.com/macros/s/AKfycby6JEGPaEWrCSZn7pIP9bcbpYjffL0fvgxTDLk0Nd4_xO5j9mINkKSNGaYPiutq1Sgjsw/exec',
...
function getSampleData() {
  return {
    automate: [
      { code: '10001', emplacement: 'Data Exchange', description: 'Taille de la trame envoyée par le serveur non conforme (voir log LLUM)', causes: '--', mesures: '--', regle: '--' },
      { code: '30002', emplacement: 'Use PAP', description: 'Coordonnées de rack associées au casier erronées (RACK.Distance && NAV.diActlPos)', causes: '--', mesures: '--', regle: '--' },
      { code: '10003', emplacement: 'TcpClient', description: 'Erreur lors de la réception de la dernière trame (erreur carte KRB)', causes: '--', mesures: '--', regle: '--' },
      { code: '10004', emplacement: 'TcpClient', description: 'Perte de communication avec la carte de poids ascenseur (erreur carte KRB)', causes: '--', mesures: '--', regle: '--' },
      { code: '30004', emplacement: 'TcpClient', description: 'Perte de communication avec la carte de poids ascenseur (erreur carte KRB)', causes: 'Perte de communication avec la carte sondes de poids.', mesures: 'Acquitter (clear) le code erreur ou vérifier la connexion.', regle: '--' },
      { code: '20005', emplacement: 'Back', description: 'Perte de communication ponctuelle avec un équipement CAREL', causes: '--', mesures: '--', regle: '--' },
      { code: '30005', emplacement: 'Back', description: 'Perte de communication prolongée avec un équipement CAREL', causes: 'Perte de communication prolongée avec un équipement CAREL (froid).', mesures: 'Rebrancher physiquement la sonde de température en laissant du mou.', regle: 'Couper l\'alimentation de la sonde avant intervention.' },
      { code: '30301', emplacement: 'Drive Stepper', description: 'Perte de la communication avec le driver moteur (.HeartBit)', causes: 'Perte de communication WiFi avec la carte driver (ex: PAP).', mesures: 'RAZ du code erreur et ARM du driver concerné.', regle: 'Vérifier qu\'aucun opérateur n\'est dans la zone avant ARM.' },
      { code: '30304', emplacement: 'Drive Stepper', description: 'Echec de l\'amorçage du mouvement du moteur (.Error)', causes: 'Échec armement moteur ou blocage physique (ex: ALD2).', mesures: 'Effectuer ARM + RUN ou petit homing avant de relancer.', regle: 'S\'assurer que la zone du moteur est dégagée avant tout mouvement.' },
      { code: '30305', emplacement: 'Drive Stepper', description: 'Echec en cours de mouvement du moteur (.Error)', causes: 'Échec en cours de mouvement moteur (Drive Stepper, ALF2, ALD2).', mesures: 'Effectuer ARM + RUN ou un Homing du composant.', regle: 'S\'assurer que la zone du moteur est dégagée avant tout mouvement.' },
      { code: '30306', emplacement: 'Drive Stepper', description: 'Arrêt du mouvement sur dépassement de la consigne à la précision donnée', causes: 'Dépassement de la position target pendant le mouvement (IsMoving).', mesures: 'Faire un ARM + RUN sur le PAP pour forcer la relance.', regle: '--' },
      { code: '30606', emplacement: 'Home PAP', description: 'Blocage du pap aléatoire pendant la procédure de prise d\'origine', causes: 'Blocage PAP durant son Homing.', mesures: 'Mettre Graph Home PAP à 1 (avec Side Swap à FALSE si nécessaire).', regle: 'Couper l\'alimentation avant toute intervention manuelle sur le PAP.' },
      { code: '30611', emplacement: 'Use PAP', description: 'Blocage du pap sur le mouvement d\'approche de l\'onglet', causes: 'Blocage de la courroie préhension en approche sur onglet (.Stuck).', mesures: 'Effectuer un ARM + RUN.', regle: '--' },
      { code: '30612', emplacement: 'Use PAP', description: 'Blocage du pap lors du retour à la position d\'origine sur casier', causes: 'Blocage PAP (souvent en Kick, ou transfert lent).', mesures: 'Effectuer un ARM + RUN, et ajuster position NAV si besoin.', regle: '--' },
      { code: '30613', emplacement: 'CenterPAP', description: 'Echec du centrage du casier sur la navette (.SensorLocker_SIDE)', causes: 'Échec centrage casier (SensorLocker_SIDE perdu).', mesures: 'Recentrer le casier, mettre UsePAP à 220 et PAP.Busy à FALSE.', regle: 'Vérifier l\'absence de casier coincé avant recentrage manuel.' },
      { code: '30101', emplacement: 'Computer', description: 'Le casier présent au niveau de la façade ne peut être déposé dans le rack', causes: '--', mesures: '--', regle: '--' },
      { code: '30102', emplacement: 'Computer', description: 'Le casier appelé est introuvable dans le rack', causes: 'Casier introuvable ou désynchronisation base de données (LLUM vs Automate).', mesures: 'Mettre à jour l\'automate pour correspondre au LLUM ou libérer le casier.', regle: 'Vérifier physiquement la présence du casier avant toute mise à jour BDD.' },
    ],
    lexium: [
